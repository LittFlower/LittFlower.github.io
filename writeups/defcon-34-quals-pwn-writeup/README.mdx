...
<p>我继续卷 shellcode koh，想了想发现其实没必要死磕 <code class="inline-code">pop rdx; xchg esi, eax; syscall</code>，这个的优化看起来已经到瓶颈了，于是我尝试了另外两条路：</p>
<ol>
